...
Function_Speedtest_Fast() {
    ...
    Run_Speedtest "16171" "华南-福建移动"
    Run_Speedtest "4884" "华南-福建联通"
...
Function_BestTrace_Full() {
    ...
    if [ "${LBench_Result_NetworkStat}" = "ipv4only" ] || [ "${LBench_Result_NetworkStat}" = "dualstack" ]; then
        ...
        Run_BestTrace "5g.shunicomtest.com" "TCP" "30" "上海联通"
	Run_BestTrace "speedtest1.online.sh.cn" "TCP" "30" "上海电信speedtest"
        Run_BestTrace "180.153.28.1" "TCP" "30" "上海电信"
        Run_BestTrace "211.136.97.65" "TCP" "30" "上海移动"
	Run_BestTrace "27.159.72.10" "TCP" "30" "福建电信"
	Run_BestTrace "speedtest1.fj.chinamobile.com" "TCP" "30" "福建移动"
	Run_BestTrace "upload1.testspeed.kaopuyun.com" "TCP" "30" "福建联通"
	Run_BestTrace "210.34.0.12" "TCP" "30" "福建教育网"
	Run_BestTrace "120.42.0.1" "TCP" "30" "厦门电信"
	Run_BestTrace "110.87.104.1" "TCP" "30" "厦门电信"
	Run_BestTrace "117.30.26.1" "TCP" "30" "厦门电信"
	...
	Run_BestTrace "210.173.1.10" "TCP" "30" "日本东京-IIJ"
	Run_BestTrace "ap-northeast-1.console.aws.amazon.com" "TCP" "30" "日本东京-AWS"
	...
	Run_BestTrace "ap-northeast-2.console.aws.amazon.com" "TCP" "30" "韩国首尔AWS"
        Run_BestTrace "58.120.138.116" "TCP" "30" "韩国首尔SKBroadBand"
        Run_BestTrace "uplus.co.kr" "TCP" "30" "韩国首尔LG"
	# 新加坡部分
	Run_BestTrace "ap-southeast-1.console.aws.amazon.com" "TCP" "30" "韩国首尔KT"
        # 香港部分
        Run_BestTrace "42.200.128.126" "TCP" "30" "香港HKT-42段"
        Run_BestTrace "58.152.66.77" "TCP" "30" "香港HKT-58段"
	Run_BestTrace "ap-east-1.console.aws.amazon.com" "TCP" "30" "香港AWS"
